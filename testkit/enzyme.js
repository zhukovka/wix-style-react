...
export const boxTestkitFactory = enzymeUniTestkitFactoryCreator (
...
export const calendarPanelTestkitFactory = enzymeTestkitFactoryCreator (
  load (require ('../src/CalendarPanel/CalendarPanel.driver'))
);
export const calendarPanelFooterTestkitFactory = enzymeUniTestkitFactoryCreator (
  load (require ('../src/CalendarPanelFooter/CalendarPanelFooter.driver'))
);
export const cardGalleryItemTestkitFactory = enzymeUniTestkitFactoryCreator (
  load (require ('../src/CardGalleryItem/CardGalleryItem.driver'))
);
export const carouselTestkitFactory = enzymeTestkitFactoryCreator (
...
export const colorPickerTestkitFactory = enzymeTestkitFactoryCreator (
...
export const counterBadgeTestkitFactory = enzymeTestkitFactoryCreator (
...
export const floatingHelperTestkitFactory = enzymeTestkitFactoryCreator (
  load (require ('../src/FloatingHelper/FloatingHelper.driver'))
);
export const floatingNotificationTestkitFactory = enzymeUniTestkitFactoryCreator (
...
export const generatedTestComponentTestkitFactory = enzymeUniTestkitFactoryCreator (
  load (require ('../src/GeneratedTestComponent/GeneratedTestComponent.driver'))
);
...
export const googleAddressInputWithLabelTestkitFactory = enzymeTestkitFactoryCreator (
  load (
...
export const noBorderInputTestkitFactory = enzymeTestkitFactoryCreator (
...
export const richTextInputAreaTestkitFactory = enzymeUniTestkitFactoryCreator (
...
export const segmentedToggleTestkitFactory = enzymeUniTestkitFactoryCreator (
...
export const tagTestkitFactory = enzymeTestkitFactoryCreator (
...
export const thumbnailTestkitFactory = enzymeUniTestkitFactoryCreator (
