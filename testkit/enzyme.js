 ...
 * FILE IS BASED ON test/enzyme.template.js
...
export const dropdownPopoverTestkitFactory = enzymeUniTestkitFactoryCreator(load('../src/DropdownPopover/DropdownPopover.driver'));
