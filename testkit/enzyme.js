...
export const colorInputTestkitFactory = enzymeUniTestkitFactoryCreator(load(require('../src/ColorInput/ColorInput.driver')));
...
export const dateRangeInputTestkitFactory = enzymeUniTestkitFactoryCreator(load(require('../src/DateRangeInput/DateRangeInput.uni.driver')));