...
import { dateRangePickerDriverFactory } from '../src/DateRangePicker/DateRangePicker.driver';

export const dateRangePickerTestkitFactory = protractorUniTestkitFactoryCreator(
  dateRangePickerDriverFactory,
);
