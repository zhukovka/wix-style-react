...
const optionsWithFooter = [
  ...
  {id: 2, value: 'Option 3'},
  {id: 3, value: 'Option 4'},
  {id: 'footer', overrideStyle: true, value: <div style={{height: '240px', padding: '20px', backgroundColor: '#F0F'}}>This is a footer with a <a href="http://www.wix.com">link</a>.</div>}
];
...
export default {
  ...
  componentProps: {
    ...
    options,
    onSelect: option => console.log(`option selected. ${JSON.stringify(option)}.`)
