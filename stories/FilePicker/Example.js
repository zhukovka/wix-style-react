...
export default () =>
  <div style={{marginBottom: '100px'}}>
    ...
    <FilePicker dataHook="story-filepicker2" supportedFormats=".png, .pdf" onChange={file => console.log(file.name)} mainLabel="FilePicker with error" error errorMessage="File is too large"/>
  </div>;
