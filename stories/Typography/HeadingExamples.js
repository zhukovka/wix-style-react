...
const lightHeadingsColumn = () => (
  <div style={{backgroundColor: '#162d3d', padding: '24px'}}>
    <ExampleWrapper label="H1.Light">
      <Heading appearance="H1" light>Page Title</Heading>
    </ExampleWrapper>
    <ExampleWrapper label="H2.Light">
      <Heading appearance="H2" light>Page Section Title</Heading>
    </ExampleWrapper>
    <ExampleWrapper label="H3.Light">
      <Heading appearance="H3" light>Card Title</Heading>
    </ExampleWrapper>
    <ExampleWrapper label="H4.Light">
      <Heading appearance="H4" light>Card Content Title</Heading>
    </ExampleWrapper>
    <ExampleWrapper label="H5.Light">
      <Heading appearance="H5" light>Card Section Title</Heading>
    </ExampleWrapper>
    <ExampleWrapper label="H6.Light">
      <Heading appearance="H6" light>Card Section Title</Heading>
    </ExampleWrapper>
  </div>
);
