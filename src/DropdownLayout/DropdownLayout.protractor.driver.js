const driverFactory = component => {
  ...
  const getDropdown = () => component.$(`[data-hook="dropdown-layout-options"]`);
  const getDropdownItemElement = index => component.$$(`[data-hook="dropdown-layout-options"] div`).get(index);
