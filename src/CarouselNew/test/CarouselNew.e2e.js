...
import { carouselNewTestkitFactory } from '../../../testkit/protractor';
...
describe('CarouselNew', () => {
  ...
  const createDriver = async (dataHook = storySettings.dataHook) => {
    const driver = carouselNewTestkitFactory({ dataHook });

    await waitForVisibilityOf(
      await driver.element(),
      `Cannot find <CarouselNew/> component with dataHook of ${dataHook}`,
    );
