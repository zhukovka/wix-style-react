...
Button.propTypes = {
  ...
  theme: React.PropTypes.oneOf(['fullblue', 'emptyblue', 'emptybluesecodary', 'fullpurple', 'emptypurple', 'fullgreen', 'emptygreen', 'fullred', 'emptyred']),
  style: React.PropTypes.oneOf(['fullblue', 'emptyblue', 'emptybluesecodary', 'fullpurple', 'emptypurple', 'fullgreen', 'emptygreen', 'fullred', 'emptyred']),
