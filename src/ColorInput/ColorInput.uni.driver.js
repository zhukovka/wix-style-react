...
export const colorInputDriverFactory = base => {
  ...
  return {
    ...
    inputDriver: async () => inputTestkit(await base.getNative()), // eslint-disable-line no-restricted-properties
    /** Returns ColorPicker's component testkit methods */
    colorPickerDriver: async () => colorPickerTestkit(await base.getNative()), // eslint-disable-line no-restricted-properties
    /** Returns Popovers's component testkit methods */
    popoverDriver: async () => popoverTestkit(await base.getNative()), // eslint-disable-line no-restricted-properties
