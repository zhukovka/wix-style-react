...
import { linearProgressBarNewTestkitFactory } from '../../../testkit/protractor';
...
describe('LinearProgressBarNew', () => {
  ...
  const createDriver = async (dataHook = storySettings.dataHook) => {
    const driver = linearProgressBarNewTestkitFactory({ dataHook });

    await waitForVisibilityOf(
      await driver.element(),
      `Cannot find <LinearProgressBarNew/> component with dataHook of ${dataHook}`,
    );
