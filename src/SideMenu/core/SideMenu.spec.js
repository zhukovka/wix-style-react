...
describe('SideMenu', () => {
  ...
  it('should render full menu', () => {
    const menu = {
      header: 'Hello Header',
      navigation: [<SideMenu.NavigationLink key="0" href="//wix.com"/>,
  ...
  it('should render a sub menu', () => {
    const menu = {
      navigation: [
        ...
        <SideMenu.NavigationCategory key="1">Category 1</SideMenu.NavigationCategory>,
        <SideMenu.NavigationLink key="2" href="//wix.com"/>
      ]
    };
  ...
  it('should allow to click on a back menu', () => {
    ...
    const menu = {
      navigation: [
        <SideMenu.NavigationBackLink key="0" onBackHandler={spy}>Back</SideMenu.NavigationBackLink>
      ]
    };
